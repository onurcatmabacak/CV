...
\myname{Onur}{\bibnamedelima \c{C}atmabacak}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Onur \c{C}atmabacak}

  \makefield{\faEnvelopeO}{\texttt{onurc@physik.uzh.ch}}
  
  \makefield{\faEnvelopeO}{\texttt{onurcatmabacak@gmail.com}}
  %\makefield{\faTwitter}{\texttt{@liantze}}
  
  {\url{https://www.researchgate.net/profile/Onur_Catmabacak/}}
  
  {\url{https://www.linkedin.com/in/onurcatmabacak}}
  
  {\url{https://github.com/onurcatmabacak}}
